...
- Infer TF activity with [my BITFAM fork](https://github.com/brandonlukas/BITFAM) (custom network and multiple seeded runs) using the provided single-cell object.
...
- Optional PGD-CellOracle branch to repeat simulations on PGD-transformed embeddings generated with [PGDiffusion](https://github.com/brandonlukas/pgdiffusion).
